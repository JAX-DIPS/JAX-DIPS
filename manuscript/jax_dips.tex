...
\begin{figure}
	\centering
	\includegraphics[width=0.45\linewidth]{./figures/star_shape.png}
	\includegraphics[width=0.45\linewidth]{./figures/star_mu_m.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\linewidth]{./figures/star_num_sol.png}
	\includegraphics[width=0.45\linewidth]{./figures/star_exact_sol.png}
	\caption{Illustration of three dimensional interfaces used.}
	\label{fig:shapes}
\end{figure}
