...
\title{Differentiable residual minimization framework for learning surrogate models for elliptic problems with discontinuities}
...
\section{Solving Interfacial PDEs with Differentiable Residual Minimization (DRM)}
