...
\hline 
$2^4$ &  &     & $6.08\times 10^{-2}$ & -  & $0.0483$ & $1.85$\\ 
$2^5$ & $6.1\times 10^{-3}$  &     & $8.3 \times 10^{-2}$ & -  & $0.053$ & $2.25$\\ 
$2^6$ & $7.74\times 10^{-5}$ &     & - & -  & - & \\ 
$2^7$ & $1.97\times 10^{-5}$ &     & - & -  & - & \\ \hline
\end{tabular}
...
\begin{figure}
	...
	\caption{Illustration of numerical solution and absolute error on a $16\times 16\times 16$ uniform grid using the regression based solver. Relative error is almost $1\%$. }
	\label{fig:sphere}
\end{figure}
