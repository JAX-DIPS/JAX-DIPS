...
\begin{table}[ht]
	...
	$\rm N_{x,y,z}$   &   Solution    &   Order   &   Solution   &   Order & t (sec/epoch) & VRAM (GB)\\
	\hline 
	$2^3$ & $ 1.32\times 10^{-1}$ &   -    & $ 2.50 $                &   -   & $ 0.0225 $  & $ 1.27 $ \\
	$2^4$ & $ 5.91\times 10^{-2}$ &  $ $   & $ 6.79\times 10^{-1} $  & $ $   & $ 0.0411 $  & $ 1.27 $ \\ 
	$2^5$ & $ 2.51\times 10^{-2}$ &  $ $   & $ 3.06\times 10^{-1}$   & $ $   & $ 0.1814 $  & $ 8.3  $ \\ 
	$2^6$ & $ 2.70\times 10^{-2}$ &  $ $   & $ 2.81\times 10^{-1} $   & $ $   & $ 1.889 $  & $ 30.13 $ \\ 
	$2^7$ & $ 8.93\times 10^{-2}$ &  $ $   & $ 4.00\times 10^{-1} $   & $ $   & $ 14.022 $  & $ 32 $ \\ \hline
	\end{tabular}
...
\subsection{Case IV. A Charged Dragon}
We simulate a Poisson problem with discontinuities on the Dragon problem presented in \cite{curless1996volumetric}. In this case we used the signed-distance function produced by SDFGen, and initiated an interpolant based on its values; \textit{i.e.}, $\phi(r)$. The problem set up was $f^\pm=0,\ k^\pm=0, \ \alpha=0.1,\ \beta=1.0, \ \mu^-=1.0, \ \mu^+=2.0$ and the Dirichlet boundary condition over the walls is $u_{bc}(\{x,y,z\}\in \partial \Omega)=1/\phi(x,y,z)$. 
