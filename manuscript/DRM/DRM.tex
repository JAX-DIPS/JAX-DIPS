...
\title{JAX-DIPS: A scalable neural-numeric framework for solving elliptic problems with discontinuities across irregular interfaces}
...
Neural networks can learn solution manifolds of partial differential equations; first demonstrated by Lagaris \textit{et al.} (1998) \cite{lagaris1998artificial}. 
