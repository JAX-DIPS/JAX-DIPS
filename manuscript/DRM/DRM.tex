...
\section{Neural Bootstrapping Method} \label{sec:nbm}
...
%         \centering
%         \includegraphics[width=\textwidth]{./figures/jax_dips_paper_kernel.png}
%         \caption{NBM kernel is applied on each collocation point. Kernel involves construction of implicit compute cells at different resolutions according to the bootstrapped finite discretization method to evaluate the discretization residual.}
%         \label{fig:nbm_kernel}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[b]{\textwidth}
...
%     \end{subfigure}
%        \caption{Overall design of the neural bootstrapping method.}
%        \label{fig:nbm}
%\end{figure}
...
\section{Conclusion \& Future Directions} \label{sec:conc}
