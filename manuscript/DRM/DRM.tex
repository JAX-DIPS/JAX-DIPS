...
We used 1 NVIDIA DGX machine with 8 V100 GPUs (each with 32 GB VRAM used at $100\%$ thread and memory utility) to train a surrogate model at base resolution of $512^3$ and refined up to $4096^3$ with 1000 stars in the box. Figure \ref{fig:starbox512} is a visualization of this setting.
