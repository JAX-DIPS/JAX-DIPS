...
C                        = z_solvent * e_tilde / (4.0 * 3.141592653589793 * epsilon_0 * K_B * T)          # C term in the rhs of eqn 2 in Geng & Zhao's two-component formulation
